...
#ifndef _design_1_microblaze_0_xlconcat_2_core_h_
#define _design_1_microblaze_0_xlconcat_2_core_h_
...
class design_1_microblaze_0_xlconcat_2_core : public sc_module 
{
    public: 
       design_1_microblaze_0_xlconcat_2_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(design_1_microblaze_0_xlconcat_2_core);
    ...
    virtual ~design_1_microblaze_0_xlconcat_2_core() = default;
