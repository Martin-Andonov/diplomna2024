...
#                script (type 'microblaze_mcs_riscv_0.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/martin/Desktop/diplomna2024/fpga/project_1/project_1.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
