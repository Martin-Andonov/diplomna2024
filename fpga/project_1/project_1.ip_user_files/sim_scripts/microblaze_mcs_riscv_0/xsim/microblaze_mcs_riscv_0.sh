...
#
# Script generated by Vivado on Fri Jan 24 21:04:06 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : microblaze_mcs_riscv_0.sh
...
#
# Usage        : microblaze_mcs_riscv_0.sh
#                microblaze_mcs_riscv_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                microblaze_mcs_riscv_0.sh [-reset_run]
#                microblaze_mcs_riscv_0.sh [-reset_log]
#                microblaze_mcs_riscv_0.sh [-help]
#
...
# script info
echo -e "microblaze_mcs_riscv_0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./microblaze_mcs_riscv_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L microblaze_v11_0_14 -L microblaze_riscv_v1_0_3 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L iomodule_v3_1_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot microblaze_mcs_riscv_0 xil_defaultlib.microblaze_mcs_riscv_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim microblaze_mcs_riscv_0 -key {Behavioral:sim_1:Functional:microblaze_mcs_riscv_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_04f4_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb microblaze_mcs_riscv_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./microblaze_mcs_riscv_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: microblaze_mcs_riscv_0.sh [-help]\n\
Usage: microblaze_mcs_riscv_0.sh [-step]\n\
Usage: microblaze_mcs_riscv_0.sh [-lib_map_path]\n\
Usage: microblaze_mcs_riscv_0.sh [-reset_run]\n\
Usage: microblaze_mcs_riscv_0.sh [-reset_log]\n\
Usage: microblaze_mcs_riscv_0.sh [-keep_index]\n\
Usage: microblaze_mcs_riscv_0.sh [-noclean_files]\n\n\
