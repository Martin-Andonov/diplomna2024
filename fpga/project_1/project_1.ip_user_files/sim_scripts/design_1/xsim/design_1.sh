...
#
# Script generated by Vivado on Fri Jan 24 21:41:43 +0200 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L microblaze_v11_0_14 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_20 -L xlconcat_v2_1_6 -L mdm_v3_2_27 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L lib_pkg_v1_0_4 -L interrupt_control_v3_1_5 -L axi_iic_v2_1_9 -L dist_mem_gen_v8_0_15 -L lib_srl_fifo_v1_0_4 -L lib_fifo_v1_0_20 -L axi_quad_spi_v3_2_32 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/bd_04f4_0.protoinst" -log simulate.log
}
