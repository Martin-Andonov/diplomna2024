...
HD_PWD='C:/Users/martin/Desktop/diplomna2024/fpga/project_1/project_1.runs/microblaze_mcs_riscv_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_mcs_riscv_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_mcs_riscv_0.tcl
